...
from history_api.events_month_day import search_events_month_day, LANGUAGES
...
def test_should_work_with_capitalized_lang_month():
    ...
    month = '3'
    day = '6'
    result = search_events_month_day(lang, month, day)
    assert result
...
def test_should_return_an_error_saying_that_the_lang_and_month_does_not_exist():
    ...
    with raises(ValueError) as error:
        search_events_month_day(lang, month, day)
